-- CreateEnum
CREATE TYPE "finalidade_saida" AS ENUM ( 'agua',
    'energia',
    'gas',
    'salario',
...
CREATE TYPE "status_pagamento" AS ENUM ( 'aberto',
    'quitado',
    'vencido',
    'renegociado'
);
...
CREATE TYPE "forma_pagamento" AS ENUM ( 'dinheiro',
    'cheque',
    'cartao'
);
...
ALTER TABLE "usuario"
    ADD CONSTRAINT "usuario_contato_uid_fkey" FOREIGN KEY ("contato_uid") REFERENCES "contato" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "produto"
    ADD CONSTRAINT "produto_tipo_fkey" FOREIGN KEY ("tipo") REFERENCES "tipo_produto" ("nome") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "produto"
    ADD CONSTRAINT "produto_marca_fkey" FOREIGN KEY ("marca") REFERENCES "marca_produto" ("nome") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "valor_produto"
    ADD CONSTRAINT "valor_produto_produto_uid_fkey" FOREIGN KEY ("produto_uid") REFERENCES "produto" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "servico"
    ADD CONSTRAINT "servico_dentista_uid_fkey" FOREIGN KEY ("dentista_uid") REFERENCES "contato" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "produto_servico"
    ADD CONSTRAINT "produto_servico_produto_uid_fkey" FOREIGN KEY ("produto_uid") REFERENCES "produto" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "produto_servico"
    ADD CONSTRAINT "produto_servico_servico_uid_fkey" FOREIGN KEY ("servico_uid") REFERENCES "servico" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "produto_servico"
    ADD CONSTRAINT "produto_servico_etapa_fkey" FOREIGN KEY ("etapa") REFERENCES "etapa_fabricacao" ("nome") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "lancamento_financeiro"
    ADD CONSTRAINT "lancamento_financeiro_servico_uid_fkey" FOREIGN KEY ("servico_uid") REFERENCES "servico" ("uid") ON DELETE SET NULL ON
    UPDATE
        CASCADE;

-- AddForeignKey

ALTER TABLE "lancamento_saida"
    ADD CONSTRAINT "lancamento_saida_contato_uid_fkey" FOREIGN KEY ("contato_uid") REFERENCES "contato" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "lancamento_saida"
    ADD CONSTRAINT "lancamento_saida_uid_fkey" FOREIGN KEY ("uid") REFERENCES "lancamento_financeiro" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "parcela"
    ADD CONSTRAINT "parcela_lancamento_financeiro_uid_fkey" FOREIGN KEY ("lancamento_financeiro_uid") REFERENCES "lancamento_financeiro" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;
...
ALTER TABLE "pagamento"
    ADD CONSTRAINT "pagamento_parcela_uid_fkey" FOREIGN KEY ("parcela_uid") REFERENCES "parcela" ("uid") ON DELETE RESTRICT ON
    UPDATE
        CASCADE;

-- AddForeignKey

ALTER TABLE "_servico_paciente"
    ADD CONSTRAINT "_servico_paciente_A_fkey" FOREIGN KEY ("A") REFERENCES "contato" ("uid") ON DELETE CASCADE ON
    UPDATE
        CASCADE;
...
ALTER TABLE "_servico_paciente"
    ADD CONSTRAINT "_servico_paciente_B_fkey" FOREIGN KEY ("B") REFERENCES "servico" ("uid") ON DELETE CASCADE ON
    UPDATE
        CASCADE;

-- AddForeignKey

ALTER TABLE "_contato_categoria"
    ADD CONSTRAINT "_contato_categoria_A_fkey" FOREIGN KEY ("A") REFERENCES "categoria" ("uid") ON DELETE CASCADE ON
    UPDATE
        CASCADE;
