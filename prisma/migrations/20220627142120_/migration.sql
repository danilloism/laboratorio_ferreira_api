...
-- CreateEnum
CREATE TYPE "finalidade_saida_enum" AS ENUM ('agua', 'energia', 'gas', 'salario', 'repasse_dent_esp_odont', 'pgmnt_fornecedor', 'outro');

-- CreateEnum
CREATE TYPE "status_pagamento_enum" AS ENUM ('aberto', 'quitado', 'vencido', 'renegociado');

-- CreateEnum
CREATE TYPE "forma_pagamento_enum" AS ENUM ('dinheiro', 'cheque', 'cartao');
