...
CREATE TYPE "finalidade_saida_enum_new" AS ENUM ( 'AGUA',
    'ENERGIA',
    'GAS',
    'SALARIO',
...
ALTER TABLE "lancamento_saida" ALTER COLUMN "finalidade" TYPE "finalidade_saida_enum_new"
USING ("finalidade"::text:: "finalidade_saida_enum_new");
...
CREATE TYPE "forma_pagamento_enum_new" AS ENUM ( 'DINHEIRO',
    'CHEQUE',
    'CARTAO'
);
...
ALTER TABLE "lancamento_financeiro" ALTER COLUMN "forma_pagamento" TYPE "forma_pagamento_enum_new"
USING ("forma_pagamento"::text:: "forma_pagamento_enum_new");
...
CREATE TYPE "role_enum_new" AS ENUM ( 'ADMIN',
    'GERENTE',
    'COLABORADOR',
    'DENTISTA',
    'CLIENTE',
...
ALTER TABLE "contato" ALTER COLUMN "categorias" TYPE "role_enum_new"[]
USING ("categorias"::text:: "role_enum_new"[]);
...
CREATE TYPE "status_pagamento_enum_new" AS ENUM ( 'ABERTO',
    'QUITADO',
    'VENCIDO',
    'RENEGOCIADO'
);

ALTER TABLE "parcela" ALTER COLUMN "status" TYPE "status_pagamento_enum_new"
USING ("status"::text:: "status_pagamento_enum_new");
