-- CreateEnum
CREATE TYPE "Role" AS ENUM ('usuario', 'admin', 'colaborador', 'desenvolvedor');
...
-- AddForeignKey
ALTER TABLE "telefone" ADD CONSTRAINT "telefone_contato_id_fkey" FOREIGN KEY ("contato_id") REFERENCES "contato"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
